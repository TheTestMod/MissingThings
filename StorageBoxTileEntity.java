...
public class StorageBoxTileEntity extends TileEntity implements IInventory {
	// Create and initialize the items variable that will store store the items
	private final int NUMBER_OF_SLOTS = 54; //default 9
	private ItemStack[] itemStacks;

	public StorageBoxTileEntity()
	{
	...
	public boolean isEmpty()
  {
	...
	public String getName() {
		return "container.storage_box.name";
	}
